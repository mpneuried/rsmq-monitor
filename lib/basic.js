(function() {
  var Basic, RedisInst, colors, config, extend, _,
  ...
  module.exports = Basic = (function(_super) {
    ...
    */
    ...
    function Basic(options) {
      ...
      this.redisConnect = __bind(this.redisConnect, this);
    ...
    */
    ...
    Basic.prototype.redisConnect = function() {
      var _this = this;
      process.nextTick(function() {
        var _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
        if (((_ref = _this.rsmqConf) != null ? (_ref1 = _ref.constructor) != null ? _ref1.name : void 0 : void 0) === "RedisClient") {
          _this.redis = _this.rsmqConf;
        } else if (((_ref2 = _this.rsmqConf) != null ? (_ref3 = _ref2.client) != null ? (_ref4 = _ref3.constructor) != null ? _ref4.name : void 0 : void 0 : void 0) === "RedisClient") {
          _this.redis = _this.rsmqConf.client;
        } else {
          _this.redis = RedisInst.createClient(((_ref5 = _this.rsmqConf) != null ? _ref5.port : void 0) || 6379, ((_ref6 = _this.rsmqConf) != null ? _ref6.host : void 0) || "127.0.0.1", ((_ref7 = _this.rsmqConf) != null ? _ref7.options : void 0) || {});
        }
        _this.rsmqConf.client = _this.redis;
        _this.connect = _this.redis.connected || false;
        if (_this.connect) {
          _this.emit("connect");
        }
